function [tests] = test_tapas_sem_prosa()
%% Test 
%
...
testCase.TestData.htheta = tapas_sem_prosa_htheta();
...
ptheta = tapas_sem_prosa_wald_ptheta(); % Choose at convinience.
%ptheta.jm = testCase.TestData.jm;
...
ptheta = tapas_sem_prosa_mixedgamma_ptheta(); % Choose at convinience.
%ptheta.jm = testCase.TestData.jm;
...
ptheta = tapas_sem_prosa_gamma_ptheta(); % Choose at convinience.
%ptheta.jm = testCase.TestData.jm;
...
ptheta = tapas_sem_prosa_lognorm_ptheta(); % Choose at convinience.
%ptheta.jm = testCase.TestData.jm;
...
ptheta = tapas_sem_prosa_later_ptheta(); % Choose at convinience.
%ptheta.jm = testCase.TestData.jm;
