function [tests] = test_tapas_sem_seri()
%% Test 
%
...
% Is it a sericcade or an antisaccade
lr = zeros(nt, 1);
% Saccade to the left
lr(data(:, 6) < 640) = 1;
% Up to hear sericcades are 1 and antisaccades are 0
y.a = lr == data(:, 5);
y.a = double(y.a);
...
testCase.TestData.htheta = tapas_sem_seri_htheta();
...
ptheta = tapas_sem_seri_mixedgamma_ptheta(); % Choose at convinience.
%ptheta.jm = testCase.TestData.jm;
...
ptheta = tapas_sem_seri_lognorm_ptheta(); % Choose at convinience.
%ptheta.jm = testCase.TestData.jm;
...
ptheta = tapas_sem_seri_later_ptheta(); % Choose at convinience.
%ptheta.jm = testCase.TestData.jm;
